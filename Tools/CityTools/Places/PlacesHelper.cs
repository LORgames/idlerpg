...
namespace CityTools.Places {
    public class PlacesHelper {
        ...
        private static int FindObjectIndex() {
            ...
            for (int i = 0; i < MapPieceCache.CurrentPiece.Places.Count; i++) {
                if (currentIndex == MapPieceCache.CurrentPiece.Places[i].index) {
                    listIndex = i;
                }
            }
        ...
        internal static void SendBack() {
            ...
            MapPieceCache.CurrentPiece.Places.Sort();

            int listIndex = FindObjectIndex();

            if (listIndex != 0) {
                // Swap values
                int temp = MapPieceCache.CurrentPiece.Places[listIndex].index;
                MapPieceCache.CurrentPiece.Places[listIndex].index = MapPieceCache.CurrentPiece.Places[listIndex - 1].index;
                MapPieceCache.CurrentPiece.Places[listIndex - 1].index = temp;
        ...
        internal static void BringForward() {
            ...
            if (listIndex != MapPieceCache.CurrentPiece.Places.Count - 1) {
                // Swap values
                int temp = MapPieceCache.CurrentPiece.Places[listIndex].index;
                MapPieceCache.CurrentPiece.Places[listIndex].index = MapPieceCache.CurrentPiece.Places[listIndex + 1].index;
                MapPieceCache.CurrentPiece.Places[listIndex + 1].index = temp;
        ...
        internal static void SendToBack() {
            ...
            for (int i = listIndex; i > 0; i--) {
                int temp = MapPieceCache.CurrentPiece.Places[i].index;
                MapPieceCache.CurrentPiece.Places[i].index = MapPieceCache.CurrentPiece.Places[i - 1].index;
                MapPieceCache.CurrentPiece.Places[i - 1].index = temp;
        ...
        internal static void BringToFront() {
            ...
            for (int i = listIndex; i < MapPieceCache.CurrentPiece.Places.Count - 1; i++) {
                int temp = MapPieceCache.CurrentPiece.Places[i].index;
                MapPieceCache.CurrentPiece.Places[i].index = MapPieceCache.CurrentPiece.Places[i + 1].index;
                MapPieceCache.CurrentPiece.Places[i + 1].index = temp;
